...
export const SHOP_CATALOG: ShopCatalogItem[] = [
  ...
  { id: "interior-rose-loveseat", label: "로즈 벨벳 소파", kind: "interior", category: "인테리어", color: "#df7088", preview: "소파", price: 145, contentId: "shop-item-rose-loveseat", imageFile: "rose-loveseat.png", giftable: true },
  { id: "interior-walnut-bookcase", label: "월넛 유리 책장", kind: "interior", category: "인테리어", color: "#8a542c", preview: "책장", price: 150, contentId: "shop-item-walnut-bookcase", imageFile: "walnut-bookcase.png", giftable: true },
  { id: "interior-ivory-vanity", label: "아이보리 화장대", kind: "interior", category: "인테리어", color: "#ead5b4", preview: "화장대", price: 140, contentId: "shop-item-ivory-vanity", imageFile: "ivory-vanity.png", giftable: true },
  { id: "interior-mint-tea-cart", label: "민트 티 카트", kind: "interior", category: "인테리어", color: "#9ec8bd", preview: "카트", price: 125, contentId: "shop-item-mint-tea-cart", imageFile: "mint-tea-cart.png", giftable: true },
